...
def create_faiss_index(saved_path, chunk_size: int, chunk_overlap: int, model = "intfloat/multilingual-e5-base", output_folder = "Database"):
    '''
    ...
    documents = chunk_documents(documents, chunk_size, chunk_overlap, tokenizer_name=model)
